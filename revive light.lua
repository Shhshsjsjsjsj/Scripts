...
-- + Cred to Dripo for that stupid sound path for the original guiding lighht music :smile:
...
local RedPrimary = ColorSequence.new({
    ...
    ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 17, 112))
})
...
Camera.ChildAdded:Connect(
    function(Child): ()
        ...
        Moon.Texture = "rbxassetid://12771067678"
        HelpfulDialogue.TextColor3 = Color3.fromRGB(255, 255, 255)
