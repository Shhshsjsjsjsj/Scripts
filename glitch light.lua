...
local RedPrimary = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(195, 135, 255)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(195, 135, 255))
})
...
Camera.ChildAdded:Connect(
    function(Child): ()
        ...
        Moon.Texture = "rbxassetid://117918654678225"
        HelpfulDialogue.TextColor3 = Color3.fromRGB(195, 135, 255)
