...
local RedPrimary = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(170, 170, 85)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(170, 170, 85))
})
    ...
    function(Child): ()
        ...
        for _, Light in Lights:GetDescendants() do
            if Light:IsA("SpotLight") then
                Light.Color = Color3.fromRGB(255, 255, 127)
            end
        ...
        Moon.Texture = "rbxassetid://12771100740"
        HelpfulDialogue.TextColor3 = Color3.fromRGB(255, 255, 127)
