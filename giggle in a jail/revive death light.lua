...
local RedPrimary = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(85, 85, 0)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(85, 85, 0))
})
    ...
    function(Child): ()
        ...
        for _, Light in Lights:GetDescendants() do
            if Light:IsA("SpotLight") then
                Light.Color = Color3.fromRGB(85, 85, 0)
            end
        ...
        Moon.Texture = "rbxassetid://12771246062"
        HelpfulDialogue.TextColor3 = Color3.fromRGB(85, 85, 0)
